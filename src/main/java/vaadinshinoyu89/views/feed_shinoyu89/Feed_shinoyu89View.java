package vaadinshinoyu89.views.feed_shinoyu89;
...
import vaadinshinoyu89.views.MainLayout;

@PageTitle("Feed_shinoyu89")
@Route(value = "feed", layout = MainLayout.class)
public class Feed_shinoyu89View extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public Feed_shinoyu89View() {
        addClassName("feedshinoyu89-view");
        setSizeFull();
        grid.setHeight("100%");
